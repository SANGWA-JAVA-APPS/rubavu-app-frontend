...
const [payment_id, setPayment_id] = useState()
  ...
  const onSubmitHandler = (e) => {
    ...
    if (id) {
      Commons.updateInvpayitem_payt(invpayitem_payt, id).then((res) => {
        resetAfterSave()
      })
    } else {
      Commons.saveInvpayitem_payt(invpayitem_payt).then((res) => {
  ...
  const getAllInvpayitem_payts = (page, size) => {
    Repository.findInvpayitem_payt(page, size).then((res) => {
  ...
  const getInvpayitem_paytById = (id) => {
    StockRepository.findInvpayitem_paytById(id).then((res) => {
      setId(res.data.id)
