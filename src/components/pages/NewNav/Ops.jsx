...
export const Ops = () => {
    ...
    const { setTrucksProcesses, setWarehouseProcesses, setVesselProcesses,        setArrivalPage,        setTallyPage,        setPurchasePage,        setSalePage,        setInvoicePage,        setReceiptPage,      setExitPage, chosenProcess
    ...
    useEffect(() => {
        ...
        setArrivalNote(prevState => ({ // reset the destination beacuse on this page the user may change the destination/source
