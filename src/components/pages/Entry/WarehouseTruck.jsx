...
function WarehouseTruck(props) {
  ...
  const fetchArrivals = async () => {
    try {
      const response = await axios.get("http://localhost:8101/codeguru/api/arrival_note/byItem");
