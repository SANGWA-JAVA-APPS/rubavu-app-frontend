  ...
  return (
    <Container fluid>
      <Row className="m-5 mt-5" style={{}}>
        <SingleNumCol
          topRightTxt1="Vessels"
          clickHandler={clickHandler}
          topRightTxt2={`RWF ${topRightTxt1}`}
          bottomLeftTxt1={bottomLeftTxt1}
          bottomLeftTxt2=""
          bg="c1"
          icon={boat}
        ...
        <SingleNumCol
          topRightTxt1="Trucks"
          clickHandler={clickHandler}
          topRightTxt2={`RWF ${topRightTxt2}`}
          bottomLeftTxt1={bottomLeftTxt2}
          bottomLeftTxt2=""
          bg="c2"
          icon={truck}
          dataTodisplay={dataTodisplay}
        ...
        <SingleNumCol
          topRightTxt1="Cargo"
          clickHandler={clickHandler}
          topRightTxt2={`RWF ${topRightTxt3}`}
          bottomLeftTxt1={bottomLeftTxt3}
          bottomLeftTxt2=""
          bg="c3"
          icon={truck}
          dataTodisplay={dataTodisplay}
        />
        <SingleNumCol
          topRightTxt1="All Revenue"
          clickHandler={clickHandler}
          topRightTxt2={`RWF ${topRightTxt4}`}
          bottomLeftTxt1=""
          bottomLeftTxt2=""
          bg="c4"
          icon={money}
...
export const CustomCardRows = ({
  ...
  return (
    <Row
      className="d-flex align-content-between p-3 "
      data-data-to-display={dataTodisplay}
      style={{ height: "100%" }}
    >
      ...
      <div
        className="  row ms-2  d-flex flex-row justify-content-start"
        style={{ fontSize: "13px" }}
      >
        <div>
          <span style={{ color: "green" }}>{bottomLeftTxt1}</span>
          <span style={{ color: "#7b7b7b" }}> {bottomLeftTxt2}</span>
        </div>
      </div>
    </Row>
  );
...
export const SingleNumCol = ({
  topRightTxt1 = "Booking",
  topRightTxt2 = "281",
  bottomLeftTxt1 = "+55%",
  bottomLeftTxt2 = "than last week",
  bg,
  icon,
  clickHandler,
  dataTodisplay,
  ...
  return (
    <Col className="" md={colSize} onClick={clickHandler}>
      <div
        onClick={setupModal}
        className={`castomCard  redBorderWhite  p-0 ${cardBg}`}
        style={{ height: cardHeight, width: colWidth }}
      >
        {cardIconShow && (
          <div className={`cardIcon shadow ${bg}`}>
            <Icon
              size={"70%"}
        ...
        <CustomCardRows
          topRightTxt1={topRightTxt1}
          topRightTxt2={topRightTxt2}
          bottomLeftTxt1={bottomLeftTxt1}
          bottomLeftTxt2={bottomLeftTxt2}
          dataTodisplay={dataTodisplay}
        />
      </div>
    </Col>
...
export const SingleNumColCustomClick = ({
  clickEvent,
  topRightTxt1 = "Booking",
  topRightTxt2 = "281",
  bottomLeftTxt1 = "+55%",
...
export const SingleNumColSamPage = ({
  topRightTxt1 = "Booking",
  topRightTxt2 = "281",
  bottomLeftTxt1 = "+55%",
  bottomLeftTxt2 = "than last week",
...
export const SingleNumColSamPageCustomClick = ({
  clickEvent,
  topRightTxt1 = "Booking",
  topRightTxt2 = "281",
  bottomLeftTxt1 = "+55%",
...
export const SingleNumColSamPageThree = ({
  topRightTxt1 = "Booking",
  topRightTxt2 = "281",
  bottomLeftTxt1 = "+55%",
  bottomLeftTxt2 = "than last week",
  ...
  const { cardIconShow, cardBg, cardHeight, colSizeTwo, colWidth } =
    useContext(ColItemContext);
  return (
    <Col className="" md={colSizeTwo}>
      <div
        className={`castomCard    p-0 ${cardBg}`}
        style={{ height: cardHeight, width: colWidth }}
      >
        {cardIconShow && (
          <div className={`cardIcon shadow ${bg}`}>
