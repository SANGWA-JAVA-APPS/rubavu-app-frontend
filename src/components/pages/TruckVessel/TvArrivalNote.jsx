...
function TvArrivalNote( ) {
    ...
    const onSubmitHandler = (e) => {
        ...
        if (id) {
            Commons.updateArrival_note(arrival_note, id, authHeader).then((res) => {
                resetAfterSave()
            })
        } else {
            Commons.saveArrival_note(arrival_note, authHeader).then((res) => {
    ...
    const getAllArrival_notes = (page, size) => {
        Repository.findArrival_note(page, size, authHeader).then((res) => {
