...
const [name, setName] = useState()
  ...
  const onSubmitHandler = (e) => {
    ...
    if (id) {
      Commons.updateCargo_dest(cargo_dest, id).then((res) => {
        resetAfterSave()
      })
    } else {
      Commons.saveCargo_dest(cargo_dest).then((res) => {
  ...
  const getAllCargo_dests = (page, size) => {
    Repository.findCargo_dest(page, size).then((res) => {
  ...
  const getCargo_destById = (id) => {
    StockRepository.findCargo_destById(id).then((res) => {
      setId(res.data.id)
