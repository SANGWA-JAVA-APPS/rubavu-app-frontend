...
import PurchaseForm, { OnlyForm } from '../Purchase/PurchaseForm'
    ...
    if (itemsId) {
      if (purchased_qty > 0) {
        ...
        if (id) {
          ...
          StockCommons.savePurchases(mdl_purchases, localStorage.getItem('userid'), itemsId, carrier, unit_cost, authHeader).then((res) => {
