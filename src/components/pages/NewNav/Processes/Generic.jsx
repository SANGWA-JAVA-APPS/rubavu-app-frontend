...
export const Generic = () => {
    ...
    return (
        <ItemsContainer  >
            <PathOpsHome >
                <Col className="col-auto p-0 m-0 ms-2"> <Link to="/startproc">Truck-Warehouse</Link></Col>
            </PathOpsHome>
            ...
            <Col md={12}  >
                ...
                {counter === 2 && <> <Splitter /> <Arrival_note />  </>}
                {counter === 3 && <> <Splitter /> <TVTallyIn />  </>}
                {counter === 4 && <> <Splitter /> <Invoice />  </>}
                {counter === 5 && <> <Splitter /> <Payment />  </>}
                {counter === 6 && <> <Splitter /> <Exits />  </>}
            </Col>
            <Col md={4}>
