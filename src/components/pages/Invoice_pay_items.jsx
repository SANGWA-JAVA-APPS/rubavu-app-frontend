...
const [name, setName] = useState()
  ...
  const onSubmitHandler = (e) => {
    ...
    if (id) {
      Commons.updateInvoice_pay_items(invoice_pay_items, id, authHeader).then((res) => {
        resetAfterSave()
      })
    } else {
      Commons.saveInvoice_pay_items(invoice_pay_items, authHeader).then((res) => {
  ...
  const getAllInvoice_pay_itemss = (page, size) => {
    Repository.findInvoice_pay_items(page, size, authHeader).then((res) => {
  ...
  const getInvoice_pay_itemsById = (id) => {
    StockRepository.findInvoice_pay_itemsById(id, authHeader).then((res) => {
      setId(res.data.id)
