...
const [arrival_id, setArrival_id] = useState()
  ...
  const onSubmitHandler = (e) => {
    ...
    if (id) {
      Commons.updateStockout_lines(stockout_lines, id, authHeader).then((res) => {
        resetAfterSave()
      })
    } else {
      Commons.saveStockout_lines(stockout_lines, authHeader).then((res) => {
  ...
  const getAllStockout_liness = (page, size) => {
    Repository.findStockout_lines(page, size, authHeader).then((res) => {
  ...
  const getStockout_linesById = (id) => {
    StockRepository.findStockout_linesById(id, authHeader).then((res) => {
      setId(res.data.id)
