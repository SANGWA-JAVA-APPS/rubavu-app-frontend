...
export const  WTrcuk=()=> {
  ...
  const getAllVessels = (page, size) => {
    StockRepository.findVessel(page, size, authHeader).then((res) => {
    ...
    <>
      ...
      {/* <PathVesselHome>
        <Col className="col-auto p-0 m-0 ms-2 ">
          <Link to="/wtruckform">Warehouse TRuck</Link>
        </Col>
      </PathVesselHome> */}

        <AnimateHeight id="animForm" duration={300} animateOpacity={true} height={height}>
          <ContainerRowBtwn clearBtn={clearBtn} form={'Warehouse Truck records'} showLoader={showLoader}  >
        ...
        <ContainerRow mt='3'>
          <ListToolBar listTitle='Warehouse Truck report' height={height} entity='Warehouse Truck records' changeFormHeightClick={() => setHeight(height === 0 ? 'auto' : 0)} changeSearchheight={() => setSearchHeight(searchHeight === 0 ? 'auto' : 0)} handlePrint={handlePrint} searchHeight={searchHeight} />
