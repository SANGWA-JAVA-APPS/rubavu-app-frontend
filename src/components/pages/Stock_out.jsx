...
const [date_time, setDate_time] = useState()
  ...
  const onSubmitHandler = (e) => {
    ...
    if (id) {
      Commons.updateStock_out(stock_out, id).then((res) => {
        resetAfterSave()
      })
    } else {
      Commons.saveStock_out(stock_out).then((res) => {
  ...
  const getAllStock_outs = (page, size) => {
    Repository.findStock_out(page, size).then((res) => {
  ...
  const getStock_outById = (id) => {
    StockRepository.findStock_outById(id).then((res) => {
      setId(res.data.id)
