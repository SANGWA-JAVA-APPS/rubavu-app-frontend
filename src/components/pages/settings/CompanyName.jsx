  ...
  return (
    <PagesWapper>
      <AnimateHeight id="animForm" duration={300} animateOpacity={true} height={height}>
        <ContainerSingleRowUpdate clearBtn={clearBtn} form='COMPANY INFORMATION' showLoader={showLoader}  >
      ...
      <ContainerRow mt='3'>
        ...
        <ListToolBar logeuserType={localStorage.getItem('catname')} defaultLabel='set company'
          listTitle={`  Company name`} height={height} entity={purchaseSwitchTSstockIn()}
