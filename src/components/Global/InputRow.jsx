...
export const InputAndSearchNoLabel = (props) => {
    return (
        <>
...
export const DropDownInputNoLabels = (props) => {
    return (<>
        {props.showmoreload &&
            <div className='row'>
                <div className='unitsLoading' style={{ backgroundColor: '#fff', position: 'relative', overflow: 'hidden', width: '380px', height: '40px' }}>
...
export const DropDownInputPad = (props) => {
    return (<>

        {/* <GenIputRow name={props.name} label={props.label}> */}

        <select required style={OtherStyles.txt()}
            onChange={props.handle} className="form-select p-4 w-100" id={props.label} >
            <option></option>
            {props.children}
        </select>
        {/* </GenIputRow> */}
