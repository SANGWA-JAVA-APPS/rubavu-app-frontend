...
const [invoicepayitems, setInvoicepayitems] = useState()
  ...
  const onSubmitHandler = (e) => {
    ...
    if (id) {
      Commons.updateInvpayitem_invoice(invpayitem_invoice, id, authHeader).then((res) => {
        resetAfterSave()
      })
    } else {
      Commons.saveInvpayitem_invoice(invpayitem_invoice, authHeader).then((res) => {
  ...
  const getAllInvpayitem_invoices = (page, size) => {
    Repository.findInvpayitem_invoice(page, size, authHeader).then((res) => {
  ...
  const getInvpayitem_invoiceById = (id) => {
    StockRepository.findInvpayitem_invoiceById(id, authHeader).then((res) => {
      setId(res.data.id)
