...
function ItemCategory() {
  ...
  const onSubmitHandler = (e) => {
    ...
    if (id) {
      StockCommons.updateItemCategory(itemsCategory, id).then((res) => {
        resetAfterSave()
      })
    } else {
      StockCommons.saveItemCategory(itemsCategory).then((res) => {
  ...
  const getItem_categoryById = (id) => {
    StockRepository.findItem_categoryById(id).then((res) => {
      setId(res.data.id)
