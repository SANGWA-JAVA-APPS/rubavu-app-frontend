         ...
         <Row className="d-flex justify-content-between">
            ...
            <Col md={5} style={{ borderLeft: '3px solid orange' }}>
                        <Link className='startProcess'
                         ...
                         onClick={(e)=>handleClick(e,2)}><Icon size={30} style={{ color: '#0b3059' }} className="me-2" icon={arrowRight} />
    ...
    <Col md={12} className='lightBg p-5 mt-3'>
        <Row className="d-flex justify-content-between">
            ...
            <Col md={5} style={{ borderLeft: '3px solid orange' }}>
                        <Link className='startProcess'
                         style={{ border: '1px solid #ccc', padding: '9px' }} 
                         onClick={(e)=>handleClick(e,6)}><Icon size={30} style={{ color: '#0b3059' }} className="me-2" icon={arrowRight} />
                            Start a new Process</Link>
            </Col>
        </Row>
    </Col>
