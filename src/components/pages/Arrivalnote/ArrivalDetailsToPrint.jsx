            ...
            <Printtemplate
                ...
                <Row>
                    ...
                    <Col md={6} className="col-6">
                        <Row>
                            ...
                            <Col md={6} className="mt-2 col-6 border-bottom ">Source </Col>
                            <Col md={6} className="mt-2 col-6 border-bottom ">{obj.arrivalObj?.sourcePlateNumber} </Col>

                            <Col md={6} className="mt-2 col-6 border-bottom ">Destination </Col>
                            <Col md={6} className="mt-2 col-6 border-bottom ">{obj.arrivalObj?.destPlateNumber} </Col>
                ...
                <Col md={12} style={{ fontSize: '14px' }}>
                    <Row>
                        ...
                        <Col md={12} style={{fontSize:'11px'}} className="mt-2 ps-5 col-2 border-bottom text-end"><i>Generated By: {obj.arrivalObj.doneBy}</i></Col>
                    </Row>
