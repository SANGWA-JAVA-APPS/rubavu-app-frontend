...
function RevenueSummary({ debtsList }) {
    ...
    const getAllHw_movements = () => {
        ...
        StockRepository.groupByInOut(SearchByDateOnly).then((res) => {
    ...
    const findDailyreport = () => {
        ...
        StockRepository.findDailyreport(SearchByDateOnly).then((res) => {
            // StockRepository.findHw_movement(SearchByDateOnly).then((res) => {
            setDailyReportList(res.data)
            //   setDataLoad(true)
        });
    ...
    const getTodayExpenses = () => {
        ...
        StockRepository.findExpenseByDate(searchByDateOnly).then((res) => {
            let resp = res.data
            ...
            <Col md={12} >
                ...
                {dailyReportList.length > 0 ?
                    ...
                    : <Row className='text-dark' >
                        <h1 className="text-uppercase mb-5">No Activity done yet Today!</h1>
                    </Row>}
            </Col>
        </Row >
    )
